...
| [`@llblab/pi-state-flow`](https://github.com/llblab/pi-state-flow) | `0.11.2` | Durable scoped state with native session compaction, exact publication, and hierarchical read-only Telegram inspection |
